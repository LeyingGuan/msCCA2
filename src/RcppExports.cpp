...
RcppExport SEXP _msCCA2_my_range(SEXP n1SEXP, SEXP n2SEXP) {
BEGIN_RCPP
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type l1norm_max(l1norm_maxSEXP);
    Rcpp::traits::input_parameter< double >::type l1norm_min(l1norm_minSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type warm_up(warm_upSEXP);
